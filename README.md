...
You have to design & build the backend for the application and the ability for the users to register, list items and bid for items.
...
https://github.com/azaylamba/OnlineBiddingPlatform 
